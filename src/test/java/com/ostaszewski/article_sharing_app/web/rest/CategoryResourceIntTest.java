...
public class CategoryResourceIntTest {
     ...
     *
     * @see com.ostaszewski.article_sharing_app.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final CategoryResource categoryResource = new CategoryResource(categoryRepository, categoryMapper, mockCategorySearchRepository);
