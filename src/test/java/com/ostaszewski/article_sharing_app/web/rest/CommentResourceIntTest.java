...
public class CommentResourceIntTest {
    ...
    private static final Instant DEFAULT_CREATION_DATE = Instant.now().minus(1, ChronoUnit.DAYS);
    private static final Instant UPDATED_CREATION_DATE = Instant.now(Clock.system(ZoneId.systemDefault()));

    private static final Instant DEFAULT_MODIFICATION_DATE = Instant.now().minus(1, ChronoUnit.DAYS);
    private static final Instant UPDATED_MODIFICATION_DATE = Instant.now().minus(1, ChronoUnit.DAYS);
     ...
     *
     * @see com.ostaszewski.article_sharing_app.repository.search.CommentSearchRepositoryMockConfiguration
     */
    @Autowired
