...
import com.ostaszewski.article_sharing_app.service.MessageService;
...
public class MessageResourceIntTest {
     ...
     *
     * @see com.ostaszewski.article_sharing_app.repository.search.MessageSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message();
            ...
            message.setCreationDate(DEFAULT_CREATION_DATE);
        return message;
    }
    ...
    public void updateMessage() throws Exception {
        ...
        em.detach(updatedMessage);
            ...
            updatedMessage.setCreationDate(UPDATED_CREATION_DATE);
