...
public class ArticleResourceIntTest {
    ...
    private static final Instant UPDATED_MODIFICATION_DATE = Instant.now(Clock.system(ZoneId.systemDefault()));
     ...
     *
     * @see com.ostaszewski.article_sharing_app.repository.search.ArticleSearchRepositoryMockConfiguration
     */
    @Autowired
