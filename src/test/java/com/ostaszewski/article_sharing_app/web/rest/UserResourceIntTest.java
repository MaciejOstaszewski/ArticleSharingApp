...
import com.ostaszewski.article_sharing_app.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
     ...
     *
     * @see com.ostaszewski.article_sharing_app.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static User createEntity(EntityManager em) {
        ...
        user.setAvatar(DEFAULT_IMAGEURL);
    ...
    public void createUser() throws Exception {
        ...
        assertThat(testUser.getAvatar()).isEqualTo(DEFAULT_IMAGEURL);
    ...
    public void updateUser() throws Exception {
        ...
        assertThat(testUser.getAvatar()).isEqualTo(UPDATED_IMAGEURL);
    ...
    public void updateUserExistingEmail() throws Exception {
        ...
        managedUserVM.setActivated(updatedUser.isActivated());
        managedUserVM.setImageUrl(updatedUser.getAvatar());
    ...
    public void testUserDTOtoUser() {
        ...
        assertThat(user.getAvatar()).isEqualTo(DEFAULT_IMAGEURL);
