...
public class TagResourceIntTest {
     ...
     *
     * @see com.ostaszewski.article_sharing_app.repository.search.TagSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final TagResource tagResource = new TagResource(tagRepository, tagMapper, mockTagSearchRepository);
