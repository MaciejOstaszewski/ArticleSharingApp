...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', () => {
        ...
        expect(tagComponentsPage.getTitle()).toMatch(/articleSharingApp.tag.home.title/);
    });

    it('should load create Tag page', () => {
        tagComponentsPage.clickOnCreateButton();
        tagUpdatePage = new TagUpdatePage();
        expect(tagUpdatePage.getPageTitle()).toMatch(/articleSharingApp.tag.home.createOrEditLabel/);
