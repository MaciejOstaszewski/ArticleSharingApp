...
describe('Category e2e test', () => {
    ...
    it('should load Categories', () => {
        ...
        expect(categoryComponentsPage.getTitle()).toMatch(/articleSharingApp.category.home.title/);
    });

    it('should load create Category page', () => {
        categoryComponentsPage.clickOnCreateButton();
        categoryUpdatePage = new CategoryUpdatePage();
        expect(categoryUpdatePage.getPageTitle()).toMatch(/articleSharingApp.category.home.createOrEditLabel/);
