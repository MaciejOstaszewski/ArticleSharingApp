    ...
    describe('Rate Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rates';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Rate', () => {
                service.create(new Rate(null)).subscribe(received => {
            ...
            it('should update a Rate', () => {
                service.update(new Rate(123)).subscribe(received => {
