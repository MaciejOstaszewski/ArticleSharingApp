package com.ostaszewski.article_sharing_app.security;
...
public class DomainUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(final String login) {
        ...
        Optional<User> userByLoginFromDatabase = userRepository.findOneWithAuthoritiesByLoginToAuthenticate(lowercaseLogin);
